...
Chef is currently working for a secret research group called NEXTGEN. While the rest of the world 
is still in search of a way to utilize Helium-3 as a fuel, NEXTGEN scientists have been able to achieve 2 major milestones:
...
Output Format:
For each test case print on a single line the answer — "Yes" if NEXTGEN satisfies the government's 
minimum requirements for funding and "No" otherwise.
